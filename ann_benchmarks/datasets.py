...
DATASETS = {
    ...
    'glove-25-angular-workload': lambda out_fn: glove(out_fn, 25),
    'glove-25-euclidean-workload': lambda out_fn: glove(out_fn, 25),
    'glove-25-euclidean-workload-testing': lambda out_fn: glove(out_fn, 25),
    'glove-25-euclidean-workload_clusters': lambda out_fn: glove(out_fn, 25),
    'glove-25-euclidean-workload_top_p': lambda out_fn: glove(out_fn, 25),
    'glove-25-euclidean-workload_clusters_p': lambda out_fn: glove(out_fn, 25),
    'glove-25-euclidean-workload-model': lambda out_fn: glove(out_fn, 25),
    'glove-25-angular-workload-more-accurate': lambda out_fn: glove(out_fn, 25),
    'glove-50-angular': lambda out_fn: glove(out_fn, 50),
    'glove-50-angular-workload': lambda out_fn: glove(out_fn, 50),
